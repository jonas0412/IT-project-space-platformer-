...
from scripts.utils import load_images, load, save, load_image, scale_images, load_sheet
...
class Editor:
    def __init__(self,size=(640, 480)):
        ...
        self.assets = {
            'tiles': scale_images(load_images('tiles/'), (32, 32)),
            'spawners': scale_images([load_sheet('player.png', 1, (32,32),1) ,load_image('entities/enemy/Enemy.png')], (32, 32)),
        }
